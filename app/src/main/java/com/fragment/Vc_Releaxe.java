...
public class Vc_Releaxe extends LFragment implements ViewPager.OnPageChangeListener {
    ...
    public static Vc_Releaxe getIntenceR;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        getIntenceR = this;
       // LSharePreference.getInstance(getActivity()).setString("tID", "1");
        initView();
        initData();
...
//                }
    ...
    private void initData() {
        ...
        for (int i = 0; i < cVchild.size(); i++) {
            if (cVchild.get(i).getTitle().equals("休闲") && cVchild.get(i).getPid().equals(pid)) {
                cvh.setId(cVchild.get(i).getId());
                cvh.setPid(cVchild.get(i).getPid());
                cvh.setTitle(cVchild.get(i).getTitle());
                //L.e(cvh.getPid() + cvh.getId() + cvh.getTitle());
            }
        }
        // L.e(cvh.getTitle()+cvh.getId()+cvh.getPid()+"dddddddddddddddddddddddd");
